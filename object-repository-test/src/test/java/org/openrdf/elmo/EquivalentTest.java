...
public class EquivalentTest extends TestCase {
	...
	private static final String EQU = "http://example.org/equivalent#";

	/** Directory used to store files generated by this test case. */
	private static File targetDir;

	public void testEquivalent() throws Exception {
		File jar = createFile("equivalent.jar");
		OntologyConverter converter = createConventer();
		converter.addRdfSource(find("/ontologies/equivalent-ontology.owl"));
		converter.bindPackageToNamespace("concepts.equivalent", EQU);
		converter.init();
		converter.createClasses(jar);
		assertTrue(jar.isFile());
		assertEquals(7, countClasses(jar, ".java"));
		assertEquals(7, countClasses(jar, ".class"));
	}
