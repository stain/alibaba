...
public class ElmoQueryTest extends ElmoManagerTestCase {
	...
	public void testBeanQuery() throws Exception {
		ElmoQuery query = manager.createQuery(QUERY_PERSON_SMITH);
		int count = 0;
	...
	public void testTupleQuery() throws Exception {
		ElmoQuery query = manager.createQuery(QUERY_PERSON_NAME_SMITH);
		int count = 0;
	...
	public void testLiteralQuery() throws Exception {
		ElmoQuery query = manager.createQuery(QUERY_NAME_SMITH);
		int count = 0;
